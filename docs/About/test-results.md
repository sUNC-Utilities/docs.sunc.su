...
Even if someone tries to replicate the link or manually upload fake data and use it with the results viewer (since [Rubiš is also a public paste service](https://rubis.numelon.com) which is usable by anyone), it will not work.
